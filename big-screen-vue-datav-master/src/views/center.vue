<template>
  <div id="center">
    <div class="up">
      ...
      >
        <p class="ml-3 colorBlue fw-b fs-xl">车辆最多销售额</p>
        <div style="text-align: center;line-height: 2">
...
export default {
  ...
  async mounted(){
    ...
    console.log(res.data.oilRate)
    console.log(res.data.electricRate)
    console.log(res.data.mixRate)
  }
}
</script>
